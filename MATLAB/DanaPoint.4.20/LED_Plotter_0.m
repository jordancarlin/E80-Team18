...
yellowVoltage = yellowVoltage(1:find(yellowVoltage <= 0.001, 1, "first"));
greenVoltage = greenVoltage(1:find(greenVoltage <= 0.001, 1, "first"));
visibleVoltage = visibleVoltage(1:find(visibleVoltage <= 0.001, 1, "first"));
IRLEDVoltage = IRLEDVoltage(1:find(IRLEDVoltage <= 0.001, 1, "first"));
redVoltage = redVoltage(1:find(redVoltage <= 0.001, 1, "first"));
