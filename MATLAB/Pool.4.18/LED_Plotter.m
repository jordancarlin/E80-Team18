...
% IRPhotoVoltage = IRPhotoVoltage(1:find(IRPhotoVoltage <= 0.00000001, 1, "first"));
...
title("Voltage vs Depth of IR LED", FontSize=20);
axis tight
...
xlabel("Depth [m]", FontSize=16);
ylabel("Voltage [V]", FontSize=16);
title("Voltage vs Depth of IRPhotodiode", FontSize=20);
